    ...
    function editorHtml (content, options) {
        ...
        html += '<div class="md-toolbar">';
            html += '<div class="btn-toolbar">';
                ...
                html += '<div class="btn-group">';
                    html += '<button type="button" data-mdtooltip="tooltip" title="' + options.label.btnBold + '" class="md-btn btn btn-sm btn-default" data-btn="bold"><i class="fa fa-bold"></i></button>';
                    html += '<button type="button" data-mdtooltip="tooltip" title="' + options.label.btnItalic + '" class="md-btn btn btn-sm btn-default" data-btn="italic"><i class="fa fa-italic" aria-hidden="true"></i></span></button>';
                html += '</div>'; // .btn-group

                html += '<div class="btn-group">';
                    html += '<button type="button" data-mdtooltip="tooltip" title="' + options.label.btnList + '" class="md-btn btn btn-sm btn-default" data-btn="ul"><i class="fa fa-list" aria-hidden="true"></i></button>';
                    html += '<button type="button" data-mdtooltip="tooltip" title="' + options.label.btnOrderedList + '" class="md-btn btn btn-sm btn-default" data-btn="ol"><i class="fa fa-th-list" aria-hidden="true"></i></button>';
                html += '</div>'; // .btn-group

                html += '<div class="btn-group">';
                    html += '<button type="button" data-mdtooltip="tooltip" title="' + options.label.btnLink + '" class="md-btn btn btn-sm btn-default" data-btn="link"><i class="fa fa-link" aria-hidden="true"></i></button>';
                    html += '<button type="button" data-mdtooltip="tooltip" title="' + options.label.btnImage + '" class="md-btn btn btn-sm btn-default" data-btn="image"><i class="fa fa-picture-o" aria-hidden="true"></i></button>';
                    if (options.imageUpload === true) {
                        html += '<div data-mdtooltip="tooltip" title="' + options.label.btnUpload + '" class="btn btn-sm btn-default md-btn-file"><i class="fa fa-upload" aria-hidden="true"></i><input class="md-input-upload" type="file" multiple accept=".jpg,.jpeg,.png,.gif"></div>';
                    }
                html += '</div>'; // .btn-group

                if (options.fullscreen === true) {
                    html += '<div class="btn-group pull-right">';
                        html += '<button type="button" class="md-btn btn btn-sm btn-default" data-btn="fullscreen"><i class="icon-fullscreen"></i> ' + options.label.btnFullscreen + '</button>';
                    html += '</div>'; // .btn-group
                }

                if (options.preview === true) {
                    html += '<div class="btn-group pull-right">';
                        html += '<button type="button" class="md-btn btn btn-sm btn-default btn-edit active" data-btn="edit"><i class="fa fa-pencil" aria-hidden="true"></i> ' + options.label.btnEdit + '</button>';
                        html += '<button type="button" class="md-btn btn btn-sm btn-default btn-preview" data-btn="preview"><i class="fa fa-eye" aria-hidden="true"></i> ' + options.label.btnPreview + '</button>';
                    html += '</div>'; // .btn-group
                }
